...
<form action="{{ route('files.store2022') }}" method="POST" enctype="multipart/form-data">

@csrf
  <label for="year">Year:</label>
  <input type="text" id="year" name="year" min="2000" max="{{ date('Y') }}" placeholder="Enter year" value="2022" readonly style="background-color:#eee;">
  ...
  <button class="btn btn-sm btn-primary" type="submit">Upload</button>
    ...
    <form action="{{ route('files.index2022') }}" method="GET" class="mb-3 d-flex" role="search">
